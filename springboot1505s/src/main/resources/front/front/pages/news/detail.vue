		...
		<view class="container" :style='{"minHeight":"100vh","width":"100%","padding":"0","position":"relative","background":"url(http://codegen.caihongy.cn/20221021/ae428fdc305b447f9c5f678cb644ddf9.jpg) no-repeat center top / 100% 100%,#3e4cc6","height":"auto"}'>
            <view :style='{"width":"100%","padding":"24rpx","flexWrap":"wrap","background":"none","display":"flex","height":"auto"}' class="detail-content">
				...
				<view class="detail-list-item" :style='{"margin":"0 0 24rpx 0","borderColor":"#846cc1","flexWrap":"wrap","borderWidth":"0 0 2rpx 0","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"padding":"0 16rpx 0 0","color":"#fff","textAlign":"left","width":"100%","lineHeight":"48rpx","fontSize":"28rpx","fontWeight":"600"}'>标题：</view>
					<view  class="text" :style='{"width":"100%","padding":"0 0 20rpx","margin":"0px","lineHeight":"48rpx","fontSize":"28rpx","color":"#dfddef"}'>{{detail.title}}</view>
				</view>
				...
				<view class="detail-list-item" :style='{"margin":"0 0 24rpx 0","borderColor":"#846cc1","flexWrap":"wrap","borderWidth":"0 0 2rpx 0","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"padding":"0 16rpx 0 0","color":"#fff","textAlign":"left","width":"100%","lineHeight":"48rpx","fontSize":"28rpx","fontWeight":"600"}'>简介</view>
					<view class="text" :style='{"width":"100%","padding":"0 0 20rpx","margin":"0px","lineHeight":"48rpx","fontSize":"28rpx","color":"#dfddef"}'>{{detail.introduction}}</view>
				</view>
