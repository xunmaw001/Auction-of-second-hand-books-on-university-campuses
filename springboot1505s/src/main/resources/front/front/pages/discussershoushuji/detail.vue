		...
		<view class="container" :style='{"minHeight":"100vh","width":"100%","padding":"0","position":"relative","background":"url(http://codegen.caihongy.cn/20221021/ae428fdc305b447f9c5f678cb644ddf9.jpg) no-repeat center top / 100% 100%,#3e4cc6","height":"auto"}'>
            <view :style='{"width":"100%","padding":"24rpx","flexWrap":"wrap","background":"none","display":"flex","height":"auto"}' class="detail-content">
				...
				<view class="detail-list-item" :style='{"margin":"0 0 24rpx 0","borderColor":"#846cc1","flexWrap":"wrap","borderWidth":"0 0 2rpx 0","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"padding":"0 16rpx 0 0","color":"#fff","textAlign":"left","width":"100%","lineHeight":"48rpx","fontSize":"28rpx","fontWeight":"600"}'>关联表id：</view>
				...
				<view class="detail-list-item" :style='{"margin":"0 0 24rpx 0","borderColor":"#846cc1","flexWrap":"wrap","borderWidth":"0 0 2rpx 0","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"padding":"0 16rpx 0 0","color":"#fff","textAlign":"left","width":"100%","lineHeight":"48rpx","fontSize":"28rpx","fontWeight":"600"}'>用户名：</view>
					<view  class="text" :style='{"width":"100%","padding":"0 0 20rpx","margin":"0px","lineHeight":"48rpx","fontSize":"28rpx","color":"#dfddef"}'>{{detail.nickname}}</view>
				</view>



				<view class="detail-list-item" :style='{"margin":"0 0 24rpx 0","borderColor":"#846cc1","flexWrap":"wrap","borderWidth":"0 0 2rpx 0","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"padding":"0 16rpx 0 0","color":"#fff","textAlign":"left","width":"100%","lineHeight":"48rpx","fontSize":"28rpx","fontWeight":"600"}'>评论内容</view>
					<view class="text" :style='{"width":"100%","padding":"0 0 20rpx","margin":"0px","lineHeight":"48rpx","fontSize":"28rpx","color":"#dfddef"}'>{{detail.content}}</view>
				</view>
				<view class="detail-list-item" :style='{"margin":"0 0 24rpx 0","borderColor":"#846cc1","flexWrap":"wrap","borderWidth":"0 0 2rpx 0","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"padding":"0 16rpx 0 0","color":"#fff","textAlign":"left","width":"100%","lineHeight":"48rpx","fontSize":"28rpx","fontWeight":"600"}'>回复内容</view>
					<view class="text" :style='{"width":"100%","padding":"0 0 20rpx","margin":"0px","lineHeight":"48rpx","fontSize":"28rpx","color":"#dfddef"}'>{{detail.reply}}</view>
				</view>
...
<script>
	export default {
		...
		async onShow(options) {
			...
			let cleanType = uni.getStorageSync('discussdiscussershoushujiCleanType')
			if(cleanType){
				uni.removeStorageSync('discussdiscussershoushujiCleanType')
				this.mescroll.num = 1
		...
		methods: {
			// 支付
			onPayTap(){
				uni.setStorageSync('paytable','discussershoushuji');
			...
			onAcrossTap(tableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
				uni.setStorageSync('crossTable','discussershoushuji');
			...
			// 获取详情
			async init(){
				let res = await this.$api.info('discussershoushuji', this.id);
			...
			async upCallback(mescroll) {
                let res = await this.$api.list('discussdiscussershoushuji', {
					page: mescroll.num,
					limit: 10,
					refid: this.id
				});
			...
			// 添加评论
			async onCommentTap() {
				this.$utils.jump(`../discussdiscussershoushuji/add-or-update?refid=${this.id}`)
			},
			onSHTap() {
