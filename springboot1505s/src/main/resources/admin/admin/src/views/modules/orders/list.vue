<template>
	<div class="main-content">
		...
		<template v-if="showFlag">
			<el-form class="center-form-pv" :style='{"width":"10%","padding":"0 6px","margin":"0 0 20px"}' :inline="true" :model="searchForm">
				<el-row :style='{"flexDirection":"column","display":"flex"}' >
					<div :style='{"margin":"0 0 4px","flexDirection":"column","display":"flex"}'>
					...
					<el-button :style='{"border":"2px solid #94C4C6","cursor":"pointer","padding":"0","boxShadow":"0px 4px 10px 0px rgba(0,0,0,0.3020)","outline":"none","margin":"10px 0 0","color":"#94C4C6","borderRadius":"30px","background":"#fff","width":"100%","fontSize":"14px","height":"40px"}' type="success" @click="search()">查询</el-button>
				</el-row>

				<el-row :style='{"margin":"20px 0","flexDirection":"column","display":"flex"}'>
					<el-button :style='{"border":"2px solid #94C4C6","cursor":"pointer","padding":"0","boxShadow":"0px 4px 10px 0px rgba(0,0,0,0.3020)","margin":"0 0 6px","outline":"none","color":"#94C4C6","borderRadius":"30px","background":"#fff","width":"100%","fontSize":"14px","height":"40px"}' v-if="isAuth('orders'+'/'+orderStatus,'新增')" type="success" @click="addOrUpdateHandler()">新增</el-button>
					...
					<download-excel v-if="isAuth('orders'+'/'+orderStatus,'导出')" class="export-excel-wrapper" :data = "dataList" :fields = "json_fields" name = "订单.xls">
						<!-- 导出excel -->
						<el-button :style='{"border":"2px solid #94C4C6","cursor":"pointer","padding":"0","boxShadow":"0px 4px 10px 0px rgba(0,0,0,0.3020)","margin":"0 0 6px","outline":"none","color":"#94C4C6","borderRadius":"30px","background":"#fff","width":"100%","fontSize":"14px","height":"40px"}' type="danger">导出</el-button>
					</download-excel>


					<el-button :style='{"border":"2px solid #94C4C6","cursor":"pointer","padding":"0","boxShadow":"0px 4px 10px 0px rgba(0,0,0,0.3020)","margin":"0 0 6px","outline":"none","color":"#94C4C6","borderRadius":"30px","background":"#fff","width":"100%","fontSize":"14px","height":"40px"}' v-if="isAuth('orders'+'/'+orderStatus,'日销量')" type="warning" @click="dayNumberChartDialog()">日销量</el-button>

					<el-button :style='{"border":"2px solid #94C4C6","cursor":"pointer","padding":"0","boxShadow":"0px 4px 10px 0px rgba(0,0,0,0.3020)","margin":"0 0 6px","outline":"none","color":"#94C4C6","borderRadius":"30px","background":"#fff","width":"100%","fontSize":"14px","height":"40px"}' v-if="isAuth('orders'+'/'+orderStatus,'月销量')" type="warning" @click="monthNumberChartDialog()">月销量</el-button>
            
					<el-button :style='{"border":"2px solid #94C4C6","cursor":"pointer","padding":"0","boxShadow":"0px 4px 10px 0px rgba(0,0,0,0.3020)","margin":"0 0 6px","outline":"none","color":"#94C4C6","borderRadius":"30px","background":"#fff","width":"100%","fontSize":"14px","height":"40px"}' v-if="isAuth('orders'+'/'+orderStatus,'年销量')" type="warning" @click="yearNumberChartDialog()">年销量</el-button>
					...
					<el-button :style='{"border":"2px solid #94C4C6","cursor":"pointer","padding":"0","boxShadow":"0px 4px 10px 0px rgba(0,0,0,0.3020)","margin":"0 0 6px","outline":"none","color":"#94C4C6","borderRadius":"30px","background":"#fff","width":"100%","fontSize":"14px","height":"40px"}' v-if="isAuth('orders'+'/'+orderStatus,'日销额')" type="warning" @click="dayAmountChartDialog()">日销额</el-button>
            
					<el-button :style='{"border":"2px solid #94C4C6","cursor":"pointer","padding":"0","boxShadow":"0px 4px 10px 0px rgba(0,0,0,0.3020)","margin":"0 0 6px","outline":"none","color":"#94C4C6","borderRadius":"30px","background":"#fff","width":"100%","fontSize":"14px","height":"40px"}' v-if="isAuth('orders'+'/'+orderStatus,'月销额')" type="warning" @click="monthAmountChartDialog()">月销额</el-button>
            
					<el-button :style='{"border":"2px solid #94C4C6","cursor":"pointer","padding":"0","boxShadow":"0px 4px 10px 0px rgba(0,0,0,0.3020)","margin":"0 0 6px","outline":"none","color":"#94C4C6","borderRadius":"30px","background":"#fff","width":"100%","fontSize":"14px","height":"40px"}' v-if="isAuth('orders'+'/'+orderStatus,'年销额')" type="warning" @click="yearAmountChartDialog()">年销额</el-button>
			...
			<!-- <div> -->
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							<el-button :style='{"border":"2px solid #94C4C6","cursor":"pointer","padding":"0 24px","boxShadow":"0px 2px 4px 0px rgba(0,0,0,0.3020)","margin":"0 10px 6px 0","color":"#94C4C6","borderRadius":"30px","background":"#fff","width":"auto","fontSize":"14px","height":"32px"}' v-if=" isAuth('orders'+'/'+orderStatus,'查看')" type="success" size="mini" @click="addOrUpdateHandler(scope.row.id,'info')">详情</el-button>
							<el-button :style='{"border":"2px solid #94C4C6","cursor":"pointer","padding":"0 24px","boxShadow":"0px 2px 4px 0px rgba(0,0,0,0.3020)","margin":"0 10px 6px 0","outline":"none","color":"#94C4C6","borderRadius":"30px ","background":"#fff","width":"auto","fontSize":"14px","height":"32px"}' v-if=" isAuth('orders'+'/'+orderStatus,'修改')" type="primary" size="mini" @click="addOrUpdateHandler(scope.row.id)">修改</el-button>

							<el-button :style='{"border":"2px solid #94C4C6","cursor":"pointer","padding":"0 24px","boxShadow":"0px 2px 4px 0px rgba(0,0,0,0.3020)","margin":"0 10px 6px 0","outline":"none","color":"#94C4C6","borderRadius":"30px ","background":"#fff","width":"auto","fontSize":"14px","height":"32px"}' v-if="isAuth('orders'+'/'+orderStatus,'物流')" type="primary" size="mini" @click="logisticsUpdate(scope.row.id)">物流</el-button>
                
							<el-button :style='{"border":"2px solid #94C4C6","cursor":"pointer","padding":"0 24px","boxShadow":"0px 2px 4px 0px rgba(0,0,0,0.3020)","margin":"0 10px 6px 0","outline":"none","color":"#94C4C6","borderRadius":"30px ","background":"#fff","width":"auto","fontSize":"14px","height":"32px"}' v-if="isAuth('orders'+'/'+orderStatus,'发货')" type="primary" size="mini" @click="updateHandler(scope.row)">发货</el-button>

							<el-button :style='{"border":"2px solid #94C4C6","cursor":"pointer","padding":"0 24px","boxShadow":"0px 2px 4px 0px rgba(0,0,0,0.3020)","margin":"0 10px 6px 0","outline":"none","color":"#94C4C6","borderRadius":"30px ","background":"#fff","width":"auto","fontSize":"14px","height":"32px"}' v-if="isAuth('orders'+'/'+orderStatus,'确认收货')" type="primary" size="mini" @click="updateHandler2(scope.row)">确认收货</el-button>




							<el-button :style='{"border":"2px solid #94C4C6","cursor":"pointer","padding":"0 24px","boxShadow":"0px 2px 4px 0px rgba(0,0,0,0.3020)","margin":"0 10px 6px 0","outline":"none","color":"#94C4C6","borderRadius":"30px","background":"#fff","width":"auto","fontSize":"14px","height":"32px"}' v-if="isAuth('orders'+'/'+orderStatus,'删除') " type="danger" size="mini" @click="deleteHandler(scope.row.id)">删除</el-button>
						</template>
					</el-table-column>
				</el-table>
				<el-pagination
...
<style lang="scss" scoped>
	...
	.center-form-pv .el-input /deep/ .el-input__inner {
				...
				outline: none;
				color: #000;
				background: linear-gradient(270deg, #94C4C6 0%, #94C4C6 13%, #FFFFFF 13%, #FFFFFF 100%);
				width: 100%;
				font-size: 14px;
				height: 40px;
			}
	...
	.el-table /deep/ .el-table__body-wrapper tbody tr:hover td {
				padding: 12px 0;
				color: #000;
				background: rgba(148, 196, 198, 0.5);
				border-color: #eee;
				border-width: 0 1px 1px 0;
				border-style: solid;
			}
