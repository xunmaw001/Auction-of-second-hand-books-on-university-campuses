        ...
        >
          ...
          >
            <template slot-scope="scope">
              <el-button
                type="text"
				:style='{"border":"2px solid #94C4C6","cursor":"pointer","padding":"0 24px","boxShadow":"0px 2px 4px 0px rgba(0,0,0,0.3020)","margin":"0 10px 6px 0","outline":"none","color":"#94C4C6","borderRadius":"30px ","background":"#fff","width":"auto","fontSize":"14px","height":"32px"}'
                size="small"
